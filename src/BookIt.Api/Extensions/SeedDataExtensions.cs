    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for (var i = 0; i < 100; i++)
        {
            apartments.Add(new
            {
                ...
                Amenities = new List<int> { (int)Amenity.Parking },
        ...
        const string sql = """
                           ...
                           (id, "name", description, address_country, address_state, address_zip_code, address_city, address_street_number, price_amount, price_currency, 
                            cleaning_fee_amount, cleaning_fee_currency, amenities, last_booked_on_utc)
